...
public class TextToSpeechService : MonoBehaviour
{
    ...
    public void ButtonClick()
    {
        ...
        using (var result = synthesizer.StartSpeakingTextAsync(outputText.text).Result)
        {
    ...
    void Start()
    {
        ...
        else
        {
            ...
            // outputText.text = "Enter text you wish spoken here.";
            message = "Click button to synthesize speech";
            speakButton.onClick.AddListener(ButtonClick);

            // Creates an instance of a speech config with specified subscription key and service region.
            speechConfig = SpeechConfig.FromSubscription(Subscription.Key, Subscription.Region);
